...
const cartSlice = createSlice(
  ...
  if (item.quantity === 0) {
    // Remove it manually, same logic as deleteItem reducer
...
export const {addItem , decreaseItemQuantity , increaseItemQuantity , deleteItem , clearCart} = cartSlice.actions;
